					...
					<div class="details_image"> 
                        @php
                            ...
                            if(count($item->images)) {
                                $main_image = $item->images[0]['img'];
                            }
                        @endphp
						<div class="details_image_large"><img src="/images/{{$main_image}}" alt="{{$item->title}}"><div class="product_extra product_new"><a href="categories.html">New</a></div></div>
                        @if(count($item->images))
						<div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
                            ...
                            <div @class([
                                ...
                                'active' => $loop->first
                                ]) data-image="/images/{{$image->img}}"><img src="/images/{{$image->img}}" alt=""></div>
							@endforeach
						</div>
                        @endif
					</div>
